...
- en android las peticiones locales no pueden hacerse a http://localhost:< port > por lo cual es necesario estar en la misma red donde esta el backend corriendo y correr el siguiente comando (si se corre la app en ios no hay ningun problema y se puede evitar el paso siguiente)
